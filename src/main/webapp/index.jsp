...
<body>
<!-- 背景 -->
<video autoplay muted loop src="./mp4/video (720p).mp4"></video>
<section>
    ...
    <div class="container">
      ...
      <div class="form">
        ...
        <form id="login-form" action="userLogin" method="post">
          <div class="inputBox">
            <!-- 用户名为必填项 -->
            <input type="text" id="userName" name="userName" placeholder="请输入用户名/账号" autofocus>
          </div>
          <div class="inputBox">
          ...
          <!-- 写入注册页面的链接 -->
          <p class="forget">没有账号？<a href="register.jsp">点击注册</a></p>
        </form>
      </div>
    </div>
  </div>
